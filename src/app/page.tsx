              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4 pt-4 border-t">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4">
                    ...
                    <div>
                      <label className="block text-sm font-bold mb-2">면접원 성명</label>
                      <input type="text" name="interviewerName" list="interviewer-list" value={formData.interviewerName} onChange={handleInputChange} className="w-full p-3 border rounded-xl"/>
                      <datalist id="interviewer-list">
                        {Array.from(new Set(surveys.map(s => s.interviewerName).filter(Boolean))).map(name => (
